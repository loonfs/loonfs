...
- The user references a `loon://<namespace>/<path>` URI or a namespace name without a local filesystem path.
...
When reporting results to the user, always include the full reference:
...
After writing, report `Wrote loon://<namespace>/<path>`.
