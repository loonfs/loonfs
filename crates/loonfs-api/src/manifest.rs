        ...
        let envelope = NamespaceManifestEnvelope::from_payload(
            ...
            NamespaceManifestPayload {
                ...
                metadata_files: vec![metadata_file_ref(
                    ...
                    ChangeSeq(10),
                    1,
                    "namespaces/demo/tables/metadata/tbl_00000000000000000000000000000001.sst",
                )],
            },
        )
        .expect("manifest");
            ...
            NamespaceManifestPayload {
                ...
                metadata_files: vec![
                    metadata_file_ref(
                        ...
                        ChangeSeq(10),
                        1,
                        "namespaces/source/tables/metadata/tbl_00000000000000000000000000000001.sst",
                    ),
                    metadata_file_ref(
                        "demo",
                        ...
                        ChangeSeq(12),
                        0,
                        "namespaces/demo/tables/metadata/tbl_00000000000000000000000000000002.sst",
                    ),
                ],
            },
        )
