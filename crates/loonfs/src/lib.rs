...
pub use loonfs_api::{
    ...
    PathEntry, PathEntryKind, PinId, ReorganizeStepOutcome, RetainedCandidates, RetainedReason,
    RevisionNo, RunMaintenanceRequest, RunMaintenanceResponse, SnapshotSummary, TrashEntry,
