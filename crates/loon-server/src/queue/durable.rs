use crate::queue::broker::{renew_broker_lease, BrokerLeaseError, BrokerLeaseOutcome};
use crate::queue::repair::{repair_lost_snapshot_enqueue, SnapshotRepairError, SnapshotRepairOutcome};
use crate::queue::types::{QueueShardEnvelope, QueueShardState, WorkClass};
...
mod tests {
    ...
    fn load_queue_shard_rejects_checksum_mismatch() {
        ...
        envelope.state.jobs.push(QueueJob {
            ...
            payload: crate::queue::types::SeqScopedPayload {
