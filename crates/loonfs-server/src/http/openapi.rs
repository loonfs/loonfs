...
use loonfs_api::{
    ...
    DeleteSnapshotResponse, DeletedCheckpointsByOwner, DeletedObjectCounts, ExtendSnapshotRequest,
    ...
    MetadataMaintenanceResponse, PinId, ReorganizeStepOutcome, RetainedCandidates, RevisionNo,
...
#[openapi(
    ...
    components(
        ...
        loonfs_api::AttributesRevisionNo,
