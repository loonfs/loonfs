...
pub(crate) const OPERATION_RETRY_CLASSES: &[(&str, RetryClass)] = &[
    ...
    ("create_snapshot", RetryClass::NotIdempotent),
    ...
    ("extend_snapshot", RetryClass::Idempotent),
    ...
    ("list_snapshots", RetryClass::Idempotent),
    ...
    ("release_snapshot", RetryClass::Idempotent),
