...
`deleted.retired_content_objects` counts attempts and repeats on every later
pass, so it is not a sign of remaining work. Late writes through already-issued upload
