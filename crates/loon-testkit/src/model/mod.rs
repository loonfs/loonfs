...
pub use client::{
    ...
    checkpoint_publish_waits_for_required_progress, delivery_order_is_seed_stable,
    download_transfer_id, duplicate_response_delivery_is_idempotent, expected_download_staged_size,
    late_remote_observation_converges_once, local_apply_failed_issue,
    local_only_matches_remote_observation, local_only_upload_failed_issue,
    local_only_upload_transfer_id, model_archive_conflict_artifact,
    ...
    remote_only_placeholder_matches_remote_observation,
    response_after_newer_observation_is_idempotent, retry_reuses_pending_request_id,
    ...
    snapshot_repair_tracks_latest_visible_head_seq,
    stale_writer_fence_survives_inflight_client_request, stale_writer_stays_fenced_after_handover,
