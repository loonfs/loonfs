...
fn model_builds_inode_transfer_reset_issue() {
    let issue = super::client::transfer_reset_issue(
        &NamespaceId::from("ns-1"),
        InodeId(42),
...
fn model_builds_local_only_transfer_reset_issue() {
    let issue = super::client::local_only_transfer_reset_issue(
        "tmp:ns-1:00000000000000000001",
        &NamespaceId::from("ns-1"),
...
fn model_advances_transfer_one_block_per_tick() {
    assert_eq!(super::client::advance_transfer_one_block(0, 2), (1, false));
    assert_eq!(super::client::advance_transfer_one_block(1, 2), (2, true));
    assert_eq!(super::client::advance_transfer_one_block(2, 2), (2, true));
}
