...
use loon_testkit::invariants::{
    ...
    evaluate_late_remote_observation_invariants, evaluate_sim_trace_determinism_invariants,
    ClientRetryReuseInvariantInputs, DuplicateResponseInvariantInputs,
    LateRemoteObservationInvariantInputs, SimTraceDeterminismInvariantInputs,
};
...
struct ClientServerFixtureRunReport {
    rendered_trace: String,
}

fn run_client_server_fixture_report(relative_path: &str) -> ClientServerFixtureRunReport {
