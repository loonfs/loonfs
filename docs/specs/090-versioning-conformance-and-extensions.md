...
For the protocol binding, spec 060 section 3.9 is the registry of stable error codes and their HTTP statuses, and the rule that clients must ignore unknown JSON response fields and tolerate unknown error codes.
